...
class Proxy implements \Temando\Shipping\Model\ResourceModel\Repository\ShipmentRepositoryInterface, \Magento\Framework\ObjectManager\NoninterceptableInterface
{
     ...
     * {@inheritdoc}
     */
    public function getById(string $shipmentId) : \Temando\Shipping\Model\ShipmentInterface
    {
     ...
     * {@inheritdoc}
     */
    public function cancel(string $shipmentId) : \Temando\Shipping\Model\ShipmentInterface
    {
        return $this->_getSubject()->cancel($shipmentId);
    }
}
